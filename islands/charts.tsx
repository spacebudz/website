...
import {
    ...
    ChartTooltip,
    ChartTooltipContent,
} from "@/islands/ui/chart/mod.tsx";
import { Separator } from "@/islands/ui/separator/mod.tsx";

export const description = "A collection of health charts.";

export function Charts() {
    return (
        <div className="mx-auto flex max-w-6xl flex-col flex-wrap items-start justify-center gap-6 sm:flex-row">
