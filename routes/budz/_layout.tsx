                    ...
                    <div className="w-full text-center mt-72 p-8 md:p-20 relative flex items-center justify-center flex-col">
                        <div className="w-full flex flex-col-reverse lg:flex-row gap-14">
                            <div className="max-w-md text-left text-xl font-mono">
                                In the vastness of space, true freedom is found
                                not in the stars, but in the code that binds
                                them.
                            </div>
                        ...
                        <div className="w-full mt-36 ml-8">
                            <img
                                draggable={false}
                                src="/spacebudz.svg"
                        ...
                        <div className="flex w-full mt-6 items-center">
                            <div className="w-full opacity-70 text-sm font-light text-left">
